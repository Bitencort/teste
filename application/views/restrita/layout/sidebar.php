<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?php echo base_url('restrita'); ?>"> <img alt="image" src="<?php echo base_url('public/restrita/assets/img/logo.png'); ?>" width="45" class="" /> <span
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo ($this->router->fetch_class() == 'depoimentos' ? 'active' : '') ?>">
                <a href="<?php echo base_url('restrita/depoimentos'); ?>" class="nav-link"><i data-feather="users"></i><span>Depoimentos</span></a>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?php echo base_url('restrita/master'); ?>">Categorias Principal</a></li>
