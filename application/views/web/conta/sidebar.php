        ...
        <div class="user">
            <figure>
                ...
                <?php if($anunciante->user_foto == "sem-foto.jpg"): ?>
                   <img width="80" src="<?php echo base_url('uploads/usuarios/semfoto/sem-foto.jpg'); ?>" alt="">
                <?php else: ?>
        ...
        <nav class="navdashboard">
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <a class="<?php echo ($this->router->fetch_method() == 'cotista' ? 'active' : ''); ?>" href="<?php echo base_url('conta/cotista/'); ?>">
                        <i class="lni-user"></i>
                        <span>Área do Cotista</span>
                    </a>
                </li>
