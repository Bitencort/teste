...
class Conta extends CI_Controller {
    ...
    public function __construct() {
        ...
        //verifico se esta logado se nao redireciona para o login
        //so vai ter acesso a esta pagina se estiver logado
...
//        exit();
        ...
        $this->load->view('web/layout/header', $data);
        $this->load->view('web/conta/cotista');
        $this->load->view('web/layout/footer');
    }
